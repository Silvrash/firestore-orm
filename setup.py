...
setup(
    name='firestorm',  # How you named your package folder (MyLib)
    packages=['firestorm'],  # Chose the same as "name"
    version='0.0.1',  # Start with a small number and increase it with every change you make
    license='MIT',  # Chose a license from here: https://help.github.com/articles/licensing-a-repository
    description='An ORM for firestor',  # Give a short description about your library
    ...
    keywords=['ORM', 'firestore', 'firestorm'],  # Keywords that define your package best
